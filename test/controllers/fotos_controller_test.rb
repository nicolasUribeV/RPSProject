...
class FotosControllerTest < ActionController::TestCase
  ...
  test "should create foto" do
    assert_difference('Foto.count') do
      post :create, foto: { DescripcionFoto: @foto.DescripcionFoto, DireccionFoto: @foto.DireccionFoto, Propiedad_id: @foto.Propiedad_id }
    end
  ...
  test "should update foto" do
    patch :update, id: @foto, foto: { DescripcionFoto: @foto.DescripcionFoto, DireccionFoto: @foto.DireccionFoto, Propiedad_id: @foto.Propiedad_id }
    assert_redirected_to foto_path(assigns(:foto))
  end
