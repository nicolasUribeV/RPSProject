...
class ServiciosControllerTest < ActionController::TestCase
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post :create, servicio: { Descripcion: @servicio.Descripcion, EstadoServicio: @servicio.EstadoServicio, NombreServicio: @servicio.NombreServicio }
    end
  ...
  test "should update servicio" do
    patch :update, id: @servicio, servicio: { Descripcion: @servicio.Descripcion, EstadoServicio: @servicio.EstadoServicio, NombreServicio: @servicio.NombreServicio }
    assert_redirected_to servicio_path(assigns(:servicio))
  end
