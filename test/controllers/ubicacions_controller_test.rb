...
class UbicacionsControllerTest < ActionController::TestCase
  ...
  test "should create ubicacion" do
    assert_difference('Ubicacion.count') do
      post :create, ubicacion: { NombreUbicacion: @ubicacion.NombreUbicacion, Ubicacion_id: @ubicacion.Ubicacion_id }
    end
  ...
  test "should update ubicacion" do
    patch :update, id: @ubicacion, ubicacion: { NombreUbicacion: @ubicacion.NombreUbicacion, Ubicacion_id: @ubicacion.Ubicacion_id }
    assert_redirected_to ubicacion_path(assigns(:ubicacion))
  end
